...
const _lr =
	...
	!["0", "false", "no", ""].includes(
		String(process.env.LIVERELOAD).toLowerCase(),
	);
...
const previewBuildTask = createTask({
	...
	call: series(
		buildTailwind,
		parallel(buildCSS, buildJS, buildPreviewPagesTask),
